...
import { Button, Input, Checkbox, Card } from 'antd';
...
export default function Base64() {
  ...
  const handleSourceCharacterSetChange = (e: ChangeEvent<HTMLSelectElement>) => {
  ...
  const handleFileDecode = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = (event) => {
        ...
        if (content) {
          setEncodedText(content.toString());
          handleDecode();
        }
      };
